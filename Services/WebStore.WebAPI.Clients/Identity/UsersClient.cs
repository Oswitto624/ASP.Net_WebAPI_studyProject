...
public class UsersClient : BaseClient, IUsersClient
{
    ...
    #region Реализация интерфейса IUserStore<User>
    ...
    #region Реализация интерфейса IUserRoleStore<User>
    ...
    #region Реализация интерфейса IUserPasswordStore<User>
    ...
    #region Реализация интерфейса IUserEmailStore<User>
    ...
    #region Реализация интерфейса IUserPhoneNumberStore<User>
    ...
    #region Реализация интерфейса IUserLoginStore<User>
    ...
    #region Реализация интерфейса IUserLockoutStore<User>
    ...
    #region Реализация интерфейса IUserTwoFactorStore<User>
    ...
    #region Реализация интерфейса IUserClaimStore<User>
